...
export const testimonials = [
  {
    ...
    image: user1,
    text: "I am extremely satisfied with the services provided. The team was responsive, professional, and delivegreen results beyond my expectations.",
  },
  {
    user: "Jane Smith",
    company: "green Horizon Technologies",
    image: user2,
...
export const checklistItems = [
  ...
  {
    title: "AI Assistance to greenuce time",
    description:
      "Track the performance of your VR apps and gain insights into user behavior.",
  },
  {
